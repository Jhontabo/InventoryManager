...
class ReservationHistoriesResource extends Resource
{
    ...
    public static function getNavigationBadge(): ?string
    {
        ...
        $count = Cache::remember(
            "nav-badge:reservation-histories:user:{$userId}:total",
            60,
            fn () => static::getModel()::where('user_id', $userId)->count()
        );
    ...
    public static function getNavigationBadgeColor(): string
    {
        ...
        $pendientes = Cache::remember(
            "nav-badge:reservation-histories:user:{$userId}:pending",
            60,
    ...
    {
        return static::userHasAnyRole(['ADMIN', 'LABORATORISTA', 'DOCENTE', 'ESTUDIANTE']);
    }
