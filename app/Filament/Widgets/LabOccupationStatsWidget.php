...
class LabOccupationStatsWidget extends BaseWidget
{
    ...
    protected function getCards(): array
    {
        ...
        return cache()->remember($cacheKey, 300, function () {
            ...
            return [
                Stat::make('Tasa de ocupación actual', round($currentOccupancy, 1).'%')
                ...
                Stat::make('Laboratorio más activo', $mostActiveLab?->name ?? 'N/A')
                    ->description($mostActiveLab ? $mostActiveLab->bookings_count.' reservas' : '')
                    ->color('warning'),

                Stat::make('Horas reservadas (aprobadas)', round($currentHours, 1).'h')
